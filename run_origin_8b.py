...
while True:
    try:
        ...
        constraint_rules = [
            ...
            "1. Responses must not exceed three sentences",  # "Constraints" aligned with financial constraint terminology [1](@ref)
            "2. Use of examples, analogies, or hypothetical scenarios is strictly prohibited",  # "Prohibited" reflects legal enforcement tone [3](@ref)
            "3. Output only core facts; omit background explanations",  # "Core facts" maintains precision requirement
            "4. For multi-step reasoning questions, provide the final conclusion directly"  # "Directly" corresponds to operative constraint principle [2](@ref)
        ]
